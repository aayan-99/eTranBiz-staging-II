...
export const careerData = {
    title: 'Work With Us',
    heroContent: `We, at eTranBiz, are fortunate enough to do great work for a variety of great clients, predominantly large enterprises. Each one of us loves what we do, whether we're working from home, or sitting in our office space in Bangalore. New members are always welcome, particularly individuals that are not just filling a role but are interested in helping us grow and growing with us. If that's you, we can't wait to hear from you.`,
    heroImg: careerHeroImg,
    contentTitle: 'CURRENT OPENINGS',
    careerDropdown: [
        {
            id: 0,
    ...
    quality: [
        `A strong work ethic and a commitment to delivering high-quality work`,
        `A passion for learning and a desire to grow and develop professionally`,
